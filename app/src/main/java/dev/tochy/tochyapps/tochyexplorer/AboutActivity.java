...
import dev.tochy.tochyapps.tochyexplorer.misc.ColorUtils;
...
import static dev.tochy.tochyapps.tochyexplorer.DocumentsActivity.getStatusBarHeight;
import static dev.tochy.tochyapps.tochyexplorer.misc.Utils.getSuffix;
import static dev.tochy.tochyapps.tochyexplorer.misc.Utils.openFeedback;
import static dev.tochy.tochyapps.tochyexplorer.misc.Utils.openPlaystore;
	...
	public void onClick(View view) {
		switch (view.getId()) {
			...
			case R.id.action_share:
				...
				String shareText = "I found Tochy file manager App very useful. Give it a try. "
