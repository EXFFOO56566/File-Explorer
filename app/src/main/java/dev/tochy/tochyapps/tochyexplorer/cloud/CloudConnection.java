package dev.tochy.tochyapps.tochyexplorer.cloud;
...
import dev.tochy.tochyapps.tochyexplorer.provider.CloudStorageProvider;
import dev.tochy.tochyapps.tochyexplorer.provider.ExplorerProvider;

import static dev.tochy.tochyapps.tochyexplorer.BuildConfig.BOX_CLIENT_ID;
import static dev.tochy.tochyapps.tochyexplorer.BuildConfig.BOX_CLIENT_KEY;
import static dev.tochy.tochyapps.tochyexplorer.BuildConfig.DROPBOX_CLIENT_ID;
import static dev.tochy.tochyapps.tochyexplorer.BuildConfig.DROPBOX_CLIENT_KEY;
import static dev.tochy.tochyapps.tochyexplorer.BuildConfig.GOOGLE_DRIVE_CLIENT_ID;
import static dev.tochy.tochyapps.tochyexplorer.BuildConfig.ONEDRIVE_CLIENT_ID;
import static dev.tochy.tochyapps.tochyexplorer.BuildConfig.ONEDRIVE_CLIENT_KEY;
...
import static dev.tochy.tochyapps.tochyexplorer.provider.CloudStorageProvider.TYPE_BOX;
import static dev.tochy.tochyapps.tochyexplorer.provider.CloudStorageProvider.TYPE_CLOUD;
import static dev.tochy.tochyapps.tochyexplorer.provider.CloudStorageProvider.TYPE_DROPBOX;
import static dev.tochy.tochyapps.tochyexplorer.provider.CloudStorageProvider.TYPE_GDRIVE;
import static dev.tochy.tochyapps.tochyexplorer.provider.CloudStorageProvider.TYPE_ONEDRIVE;
