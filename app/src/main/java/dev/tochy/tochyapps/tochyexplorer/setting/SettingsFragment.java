package dev.tochy.tochyapps.tochyexplorer.setting;
...
import static dev.tochy.tochyapps.tochyexplorer.setting.SettingsActivity.KEY_ACCENT_COLOR;
import static dev.tochy.tochyapps.tochyexplorer.setting.SettingsActivity.KEY_ADVANCED_DEVICES;
import static dev.tochy.tochyapps.tochyexplorer.setting.SettingsActivity.KEY_FILE_HIDDEN;
import static dev.tochy.tochyapps.tochyexplorer.setting.SettingsActivity.KEY_FILE_SIZE;
import static dev.tochy.tochyapps.tochyexplorer.setting.SettingsActivity.KEY_FILE_THUMBNAIL;
import static dev.tochy.tochyapps.tochyexplorer.setting.SettingsActivity.KEY_FOLDER_ANIMATIONS;
import static dev.tochy.tochyapps.tochyexplorer.setting.SettingsActivity.KEY_FOLDER_SIZE;
import static dev.tochy.tochyapps.tochyexplorer.setting.SettingsActivity.KEY_PRIMARY_COLOR;
import static dev.tochy.tochyapps.tochyexplorer.setting.SettingsActivity.KEY_RECENT_MEDIA;
import static dev.tochy.tochyapps.tochyexplorer.setting.SettingsActivity.KEY_ROOT_MODE;
import static dev.tochy.tochyapps.tochyexplorer.setting.SettingsActivity.KEY_SECURITY_ENABLED;
import static dev.tochy.tochyapps.tochyexplorer.setting.SettingsActivity.KEY_THEME_STYLE;
