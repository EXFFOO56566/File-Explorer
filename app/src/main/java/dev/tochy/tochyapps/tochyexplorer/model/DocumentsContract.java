...
import dev.tochy.tochyapps.tochyexplorer.misc.ImageUtils;
import dev.tochy.tochyapps.tochyexplorer.misc.OsCompat;
import dev.tochy.tochyapps.tochyexplorer.misc.Utils;
import dev.tochy.tochyapps.tochyexplorer.provider.DocumentsProvider;
import dev.tochy.tochyapps.tochyexplorer.provider.ExternalStorageProvider;
import dev.tochy.tochyapps.tochyexplorer.provider.UsbStorageProvider;

import static dev.tochy.tochyapps.tochyexplorer.misc.ContentProviderClientCompat.buildAssetFileDescriptor;
import static dev.tochy.tochyapps.tochyexplorer.misc.ContentProviderClientCompat.openTypedAssetFileDescriptor;
...
public final class DocumentsContract {
     ...
     * {@link dev.tochy.tochyapps.tochyexplorer.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID}.
     *
    ...
    /**
     * Build URI representing the target {@link dev.tochy.tochyapps.tochyexplorer.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} in
     * a document provider. When queried, a provider will return a single row
     * with columns defined by {@link dev.tochy.tochyapps.tochyexplorer.model.DocumentsContract.Document}.
     *
     ...
     * Build URI representing the children of the target directory in a document
     * provider. When queried, a provider will return zero or more rows with
     * columns defined by {@link dev.tochy.tochyapps.tochyexplorer.model.DocumentsContract.Document}.
     * <p>
     ...
     *            directory with MIME type of {@link dev.tochy.tochyapps.tochyexplorer.model.DocumentsContract.Document#MIME_TYPE_DIR}.
     * @see android.content.Intent#ACTION_OPEN_DOCUMENT_TREE
     * @see android.provider.DocumentsProvider#isChildDocument(String, String)
    ...
    /**
     * Extract the {@link dev.tochy.tochyapps.tochyexplorer.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     *
    ...
    /**
     * Extract the via {@link dev.tochy.tochyapps.tochyexplorer.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     */
